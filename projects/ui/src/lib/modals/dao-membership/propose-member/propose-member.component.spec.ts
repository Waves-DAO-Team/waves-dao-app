...
describe('AddMemberComponent', () => {
  let component: DaoMembershipProposeMemberComponent
  let fixture: ComponentFixture<DaoMembershipProposeMemberComponent>
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DaoMembershipProposeMemberComponent)
